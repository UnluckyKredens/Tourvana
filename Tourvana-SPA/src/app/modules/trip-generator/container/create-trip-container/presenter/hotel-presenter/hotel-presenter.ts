...
export class HotelPresenter {
  ...
  hotels: HotelModel[] = [
    { name: "sdf", url: "ssdf", price: 0},
     { name: "asd", url: "s sddf", price: 10},
     { name: "asdf", url: "s sdf6", price: 10},
     { name: "zxcv", url: "s sdqf", price: 10},
     { name: "qwer", url: "s sdrfe", price: 10},
     { name: "qwe", url: "s sdrf", price: 10}
    ]
